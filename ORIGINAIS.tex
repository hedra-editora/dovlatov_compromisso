...
\begin{quote}
\forceindent{}Nas fábricas, nas minas dos jazigos,
...
\end{flushright}
\vspace{4pt}
\noindent\emph{\ldots{} 13.30. ``E\scalebox{0.8}{NCONTRO COM UMA PESSOA INTERESSANTE}. Vladímir
...
defeito\ldots{} Creio que Miérkin também não iria convir. Outro dia uma
...
\begin{quote}
\forceindent{}Ser um herói é o que cada um de nós espera,
...
\emph{\scalebox{0.8}{RSS DA ESTÔNIA. REGIÃO DE PAIDE. PARA LINDA} \scalebox{0.8}{PEIPS. TELEGRAMA}. Cara
...
\begin{quote}
\forceindent{}Voam, ainda rumam ao destino,
...
\begin{quote}
\forceindent{}À frente há uma infernal luz generosa,
...
\begin{quote}
\forceindent{}Mas logo ali, onde insípidas bétulas,
...
\begin{quote}
\forceindent{}Ah, a gaivota que volteia a nuvem,
...
\begin{quote}
\forceindent{}Ah, tão fatigada, tão esgotada,
...
\begin{quote}
\forceindent{}Ah, eu vou me afogar no Dviná do Norte,
...
\begin{quote}
\forceindent{}Dou um suspiro ao ver Loreida\ldots{}
...
\begin{quote}
\forceindent{}Um grã"-fino acertou uma garrafa
...
\begin{quote}
\forceindent{}Andávamos perto, como duas lágrimas,
...
``\ldots{} No que estou pensando, do lado de cá da cova? Nos mistérios da
...
\begin{quote}
\forceindent{}\ldots{} É a guerra do povo,
...
\section{\uppercase{D}a realidade ao real}
...
roupa de baixo''. Já em \emph{Compromisso} (p. ), o
...
\section{\uppercase{D}ovlátov e a literatura russa}
...
estoniana, motorista de carrinhos de carga. O marido, um torneiro da
fábrica de navios, é russo, membro do partido. O bebê está dentro das
normas. (\scalebox{0.8}{DOVLÁTOV}, 2019, p. )
\end{quote}
...
milênios e que continuarão vivas até o sol deixar de brilhar\ldots{}'' (p. )
...
\section{\uppercase{D}ovlátov \protect\emph{versus} \uppercase{D}ovlátov}
...
dúvida\ldots{} (\scalebox{0.8}{DOVLÁTOV}, 2019, p. )
\end{quote}
