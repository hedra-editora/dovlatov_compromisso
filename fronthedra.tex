...
\begin{center}
\MyriadPro
{\normalsize \autor \par\vspace{-12ex}}
%\smallbreak
\end{center}
\end{vplace}
...
{\scriptsize\MyriadPro{Tradução do russo e posfácio\\Daniela Mountian e Yulia Mikaelyan}}
...
\centering\tiny\noindent{}Este livro foi impresso pela primeira vez em novembro de 2018 em papel Pólen Soft 80g. Tipologia: Adobe Devanagari. \begin{center}\normalsize\adforn{64}\end{center}
\end{minipage}
\end{center}
}
